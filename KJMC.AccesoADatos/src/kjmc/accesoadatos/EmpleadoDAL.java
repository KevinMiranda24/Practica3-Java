 ...
 */
package kjmc.accesoadatos;
import java.sql.*;
import java.util.ArrayList;
import kjmc.entidades.Empleado;
...
public class EmpleadoDAL {
 static String getFields() {
        return "e.Id, e.Nombre, e.Apellido, e.Correo, e.Puesto ";
    }
